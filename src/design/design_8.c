...
void	init_defuse_material_button(t_env *env)
{
	...
	defuse_m_btn->click_callback = (t_control_callback)ctrl_material_click;
...
void	init_emissive_material_button(t_env *env)
{
	...
	emi_m_btn->click_callback = (t_control_callback)ctrl_material_click;
...
void	init_reflection_material_button(t_env *env)
{
	...
	reflect_m_btn->click_callback = (t_control_callback)ctrl_material_click;
...
void	init_transp_material_button(t_env *env)
{
	...
	transp_m_btn->click_callback = (t_control_callback)ctrl_material_click;
