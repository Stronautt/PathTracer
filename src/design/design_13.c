...
void		init_spec_textbox(t_env *env)
{
	...
	spec->change_callback = (t_control_callback)ctrl_spec_change;
	spec->scroll_callback = (t_scroll_callback)ctrl_scroll;
...
void		init_spec_minus_button(t_env *env)
{
	...
	m_btn->click_callback = (t_control_callback)ctrl_spec_btn_click;
...
void		init_spec_plus_button(t_env *env)
{
	...
	p_btn->click_callback = (t_control_callback)ctrl_spec_btn_click;
