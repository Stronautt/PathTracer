...
void	init_add_plane_button(t_env *env)
{
	...
	plane_btn->click_callback = (t_control_callback)ctrl_add_plane;
...
void	init_add_elips_button(t_env *env)
{
	...
	elips_btn->click_callback = (t_control_callback)ctrl_add_elips;
...
void	init_add_parabol_button(t_env *env)
{
	...
	parabol_btn->click_callback = (t_control_callback)ctrl_add_parabol;
...
void	init_add_hyperbol_button(t_env *env)
{
	...
	hyperbol_btn->click_callback = (t_control_callback)ctrl_add_hyperbol;
...
void	init_add_disc_button(t_env *env)
{
	...
	disc_btn->click_callback = (t_control_callback)ctrl_add_disc;
