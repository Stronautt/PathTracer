...
void		init_scale_textbox(t_env *env)
{
	...
	scale->change_callback = (t_control_callback)ctrl_scale_change;
	scale->scroll_callback = (t_scroll_callback)ctrl_scroll;
...
void		init_scale_minus_button(t_env *env)
{
	...
	m_btn->click_callback = (t_control_callback)ctrl_scale_btn_click;
...
void		init_scale_plus_button(t_env *env)
{
	...
	p_btn->click_callback = (t_control_callback)ctrl_scale_btn_click;
