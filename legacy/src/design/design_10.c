...
void	init_negative_effect_button(t_env *env)
{
	...
	negative_e_btn->click_callback = (t_control_callback)ctrl_effect_click;
...
void	init_sepia_effect_button(t_env *env)
{
	...
	sepia_e_btn->click_callback = (t_control_callback)ctrl_effect_click;
...
void	init_grayscale_effect_button(t_env *env)
{
	...
	g_scale_e_btn->click_callback = (t_control_callback)ctrl_effect_click;
...
void	init_comic_effect_button(t_env *env)
{
	...
	comic_e_btn->click_callback = (t_control_callback)ctrl_effect_click;
