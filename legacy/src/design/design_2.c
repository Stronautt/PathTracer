...
void		init_color_textbox(t_env *env)
{
	...
	color->change_callback = (t_control_callback)ctrl_color_change;
...
void		init_minus_button(t_env *env)
{
	...
	m_btn->click_callback = (t_control_callback)ctrl_color_btn_click;
...
void		init_plus_button(t_env *env)
{
	...
	p_btn->click_callback = (t_control_callback)ctrl_color_btn_click;
