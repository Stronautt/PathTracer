...
void	init_add_sphere_button(t_env *env)
{
	...
	sphere_btn->click_callback = (t_control_callback)ctrl_add_sphere;
...
void	init_add_cylinder_button(t_env *env)
{
	...
	cylinder_btn->click_callback = (t_control_callback)ctrl_add_cylinder;
...
void	init_add_cone_button(t_env *env)
{
	...
	cone_btn->click_callback = (t_control_callback)ctrl_add_cone;
