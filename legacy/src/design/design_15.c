...
void	init_first_pos_button(t_env *env)
{
	...
	first_pos_btn->click_callback = (t_control_callback)ctrl_pos_tab_click;
...
void	init_second_pos_button(t_env *env)
{
	...
	second_pos_btn->click_callback = (t_control_callback)ctrl_pos_tab_click;
...
void	init_third_pos_button(t_env *env)
{
	...
	third_pos_btn->click_callback = (t_control_callback)ctrl_pos_tab_click;
