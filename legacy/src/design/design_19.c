...
void	init_add_cube_button(t_env *env)
{
	...
	cube_btn->click_callback = (t_control_callback)ctrl_add_cube;
...
void	init_add_torus_button(t_env *env)
{
	...
	torus_btn->click_callback = (t_control_callback)ctrl_add_torus;
...
void	init_add_mebius_button(t_env *env)
{
	...
	mebius_btn->click_callback = (t_control_callback)ctrl_add_mebius;
...
void	init_add_julia_button(t_env *env)
{
	...
	julia_btn->click_callback = (t_control_callback)ctrl_add_julia;
...
void	init_add_pyramid_button(t_env *env)
{
	...
	pyramid_btn->click_callback = (t_control_callback)ctrl_add_pyramid;
