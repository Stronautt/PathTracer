...
void		init_render_pause_button(t_env *env)
{
	...
	p_btn->visible = 1;
	p_btn->click_callback = (t_control_callback)ctrl_pause_btn_click;
...
void		init_emission_minus_button(t_env *env)
{
	...
	m_btn->click_callback = (t_control_callback)ctrl_emission_btn_click;
...
void		init_emission_plus_button(t_env *env)
{
	...
	p_btn->click_callback = (t_control_callback)ctrl_emission_btn_click;
	p_btn->callback_data = env;
