...
void	init_effects_tab_button(t_env *env)
{
	...
	effects_t->click_callback = (t_control_callback)ctrl_tabs_click;
...
void	init_bnw_effect_button(t_env *env)
{
	...
	bnw_e_btn->click_callback = (t_control_callback)ctrl_effect_click;
...
void	init_casting_effect_button(t_env *env)
{
	...
	casting_e_btn->click_callback = (t_control_callback)ctrl_effect_click;
...
void	init_fxaa_effect_button(t_env *env)
{
	...
	fxaa_e_btn->click_callback = (t_control_callback)ctrl_effect_click;
...
void	init_oil_effect_button(t_env *env)
{
	...
	oil_e_btn->click_callback = (t_control_callback)ctrl_effect_click;
