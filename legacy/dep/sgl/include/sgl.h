...
typedef struct	s_control t_control_fd;
typedef void (*t_control_callback)(void*, t_control_fd*);
typedef void (*t_scroll_callback)(void*, t_control_fd*, Sint32, Sint32);
...
typedef struct	s_control
{
	...
	uint				max_length;
	uint				min_length;
	t_control_callback	change_callback;
	t_control_callback	click_callback;
	t_scroll_callback	scroll_callback;
	void				*callback_data;
}				t_control;
